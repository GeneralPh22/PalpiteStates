...
export const COUNTRY_LEAGUES: CountryLeagues[] = [
  // ── International Competitions ──────────────────────────────────────────────
  {
    ...
    leagues: [
      ...
      { id: 31,  name: "WC Qualifiers (UEFA)" },
      { id: 35,  name: "WC Qualifiers (CONMEBOL)" },
  ...
  // ── National Leagues ────────────────────────────────────────────────────────
  { country: "Brasil",      flag: "🇧🇷", code: "BR",     leagues: [{ id: 71,  name: "Série A" }, { id: 72,  name: "Série B" }, { id: 73, name: "Copa do Brasil" }] },
