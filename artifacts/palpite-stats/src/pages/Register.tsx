    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="bg-[#09090b] border border-emerald-500/20 rounded-2xl p-10 shadow-2xl text-center max-w-md w-full">
          ...
          <h2 className="text-2xl font-display font-bold text-white mb-2">Conta criada!</h2>
          <p className="text-zinc-400 text-sm">
            Seu teste gratuito de 5 dias começou. Redirecionando...
          </p>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-md">
        <div className="bg-[#09090b] border border-white/[0.08] rounded-2xl p-8 shadow-2xl shadow-black/60">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-display font-bold text-white">Criar conta gratuita</h1>
            <p className="text-zinc-500 text-sm mt-2">
              5 dias de acesso completo, sem cartão de crédito
            </p>
          </div>

          <div className="flex items-center gap-3 bg-primary/5 border border-primary/15 rounded-xl px-4 py-3 mb-6">
            <div className="w-2 h-2 rounded-full bg-primary animate-pulse flex-shrink-0" />
            <span className="text-xs text-primary font-medium">
              Teste grátis por 5 dias · Acesso total a todas as funcionalidades
            </span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer mt-2">
              ...
              <span className="text-xs text-zinc-500 leading-relaxed">
                ...
                e concordo com a coleta e processamento dos meus dados conforme descrito (LGPD)
              </span>
            </label>
